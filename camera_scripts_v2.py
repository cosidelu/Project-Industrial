...
def take_defects_local(runtime, zed, image_zed, point_cloud, attention_radius=None):
    '''
    ...
    if zed.grab(runtime) == sl.ERROR_CODE.SUCCESS:
        ...
        # 2D GREEN DEFECT DETECTION
        # ------------------------------------------------
        defect_list = find_all_green_masks_and_centroids(bgr_image, attention_radius=attention_radius)
...
def main():
    ...
    try:
        while True:
            ...
            defect_list, bgr_image = take_defects_local(runtime, zed, image_zed, point_cloud, attention_radius=None)
